...
public class Robot extends IterativeRobot {
  ...
  SpeedControllerGroup leftDrive = new SpeedControllerGroup(leftFront, leftRear);
  SpeedControllerGroup rightDrive = new SpeedControllerGroup(rightFront, rightRear);

  DifferentialDrive tank = new DifferentialDrive(leftDrive, rightDrive);

  Spark compressor = new Spark(0);
  ...
  Solenoid sendShirts = new Solenoid(0);
  ...
  public void teleopPeriodic() {
    ...
    tank.tankDrive(.7*xbox0.getRawAxis(1), .7*xbox0.getRawAxis(5));
